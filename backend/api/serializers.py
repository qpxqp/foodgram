...
class GetShortLinkRecipeSerializer(serializers.HyperlinkedModelSerializer):

    class Meta:
        model = Recipe
        extra_kwargs = {
            # 'short-link': {'view_name': 'api:shortlink-detail'},
...
class GetRecipeListSerializer(serializers.ModelSerializer):
